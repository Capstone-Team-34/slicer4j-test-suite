 ...
 */
package xstream.core;

import xstream.converters.reflection.PureJavaReflectionProvider;
import xstream.converters.reflection.ReflectionProvider;
import xstream.core.util.PresortedMap;
import xstream.core.util.PresortedSet;
import xstream.core.util.WeakCache;
        ...
        if (reflectionProvider == null) {
            try {
                ...
                if (canUseSun14ReflectionProvider()) {
                    className = "xstream.converters.reflection.Sun14ReflectionProvider";
                } else if (canUseHarmonyReflectionProvider()) {
                    className = "xstream.converters.reflection.HarmonyReflectionProvider";
                }
                if (className != null) {
