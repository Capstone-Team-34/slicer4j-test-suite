 ...
 */
package xstream.converters.javabean;
...
import xstream.converters.reflection.MissingFieldException;
...
public class JavaBeanConverter implements Converter {
    ...
    /**
     * @deprecated As of 1.3, use {@link #JavaBeanConverter(Mapper)} and {@link xstream.XStream#aliasAttribute(String, String)}
     */
