...
import xstream.converters.*;
import xstream.converters.basic.*;
import xstream.converters.collections.*;
import xstream.converters.extended.*;
import xstream.converters.reflection.*;
import xstream.core.*;
import xstream.core.util.ClassLoaderReference;
import xstream.core.util.CompositeClassLoader;
import xstream.core.util.CustomObjectInputStream;
import xstream.core.util.CustomObjectOutputStream;
import xstream.io.HierarchicalStreamDriver;
import xstream.io.HierarchicalStreamReader;
import xstream.io.HierarchicalStreamWriter;
import xstream.io.StatefulWriter;
import xstream.io.xml.XppDriver;
import xstream.mapper.*;
 ...
 * <p/>
 * <p>
 * XStream contains a map of {@link xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link xstream.converters.Converter} interface.
 * </p>
 * <p/>
 * <p>
 * <hr>
 ...
 * {@link xstream.converters.reflection.ReflectionConverter} as the fallback
 * converter.
 * </p>
 * <p/>
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "xstream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "xstream.mapper.EnumMapper", new Class[]{Mapper.class},
                new Object[]{mapper});
        }
    ...
    private Mapper buildMapperDynamically(String className, Class[] constructorParamTypes,
        ...
        try {
            ...
            throw new xstream.InitializationException(
    ...
    protected void setupConverters() {
        ...
        if (JVM.is14()) {
            ...
            registerConverterDynamically(
                "xstream.converters.extended.SubjectConverter",
                PRIORITY_NORMAL, new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "xstream.converters.extended.ThrowableConverter",
                PRIORITY_NORMAL, new Class[]{Converter.class},
                new Object[]{reflectionConverter});
            registerConverterDynamically(
                "xstream.converters.extended.StackTraceElementConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "xstream.converters.extended.CurrencyConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "xstream.converters.extended.RegexPatternConverter",
                PRIORITY_NORMAL, new Class[]{Converter.class},
                new Object[]{reflectionConverter});
            registerConverterDynamically(
                "xstream.converters.extended.CharsetConverter",
                PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            ...
            if (jvm.loadClass("javax.xml.datatype.Duration") != null) {
                registerConverterDynamically(
                    "xstream.converters.extended.DurationConverter",
                    PRIORITY_NORMAL, null, null);
            }
            registerConverterDynamically(
                "xstream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                null, null);
            registerConverterDynamically(
                "xstream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "xstream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "xstream.converters.basic.StringBuilderConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }
    ...
    public void alias(String name, Class type) {
        if (classAliasingMapper == null) {
            throw new xstream.InitializationException("No "
     ...
     * </p>
     *
     * @see #createObjectOutputStream(xstream.io.HierarchicalStreamWriter,
     *      String)
     * @see #createObjectInputStream(xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
