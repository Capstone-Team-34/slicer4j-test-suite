...
/**
 * A SAX {@link XMLReader parser} that acts as an XStream
 * {@link xstream.io.HierarchicalStreamWriter} to enable direct generation of a
 * SAX event flow from the XStream serialization of a list of list of Java objects. <p/> As a
 * custom SAX parser, this class ignores the arguments of the two standard parse methods ({@link #parse(String)}
 * and {@link #parse(InputSource)}) but relies on a proprietary SAX property
...
public final class SaxWriter extends AbstractXmlWriter implements XMLReader {
    ...
    public final static String CONFIGURED_XSTREAM_PROPERTY =
            "http://xstream/sax/property/configured-xstream";
    ...
    public final static String SOURCE_OBJECT_LIST_PROPERTY =
            "http://xstream/sax/property/source-object-list";
