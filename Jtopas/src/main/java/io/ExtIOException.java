  ...
  implements ExceptionList 
{
  ...
  /**
   * Method to traverse the exception list. See {@link lang.ExceptionList#nextException}
   * for details.
   *
   ...
   * {@link lang.ExceptionMessageFormatter#getMessage} method.
   *
   * @return  the formatted exception message
   * @see     lang.ExceptionMessageFormatter
   */
