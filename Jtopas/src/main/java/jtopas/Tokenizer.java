 ...
 *</p><p>
 * This interface partly replaces the older {@link util.Tokenizer}
...
public interface Tokenizer {
   ...
   * the {@link jtopas.DataProvider} interface, while the
  ...
  /**
   * Setting a new {@link jtopas.spi.KeywordHandler} or removing any 
   ...
   * implement the {@link jtopas.spi.KeywordHandler} interface. If so,
   ...
   *
   * @param handler the (new) {@link jtopas.spi.KeywordHandler} to use 
  ...
  public void setKeywordHandler(jtopas.spi.KeywordHandler handler);
   ...
   /**
    * Retrieving the current {@link jtopas.spi.KeywordHandler}. The 
    * method may return <code>null</code> if there isn't any handler installed.
    *
    * @return the currently active {@link jtopas.spi.KeywordHandler} 
  ...
  /**
   * Setting a new {@link jtopas.spi.WhitespaceHandler} or removing 
   ...
   *
   * @return  the currently active {@link jtopas.spi.SeparatorHandler} 
  ...
  /**
   * Setting a new {@link jtopas.spi.SequenceHandler} or removing any 
   ...
   *
   * @param handler the (new) {@link jtopas.spi.SequenceHandler} to 
  ...
  /**
   * Retrieving the current {@link jtopas.spi.SequenceHandler}. The 
   * method may return <code>null</code> if there isn't any handler installed.
   *<br>
   * A <code>SequenceHandler</code> deals with line and block comments, strings
   * and special sequences.
   *
   * @return  the currently active {@link jtopas.spi.SequenceHandler} 
   ...
   *   implementations of {@link jtopas.spi.PatternHandler} may use
