 ...
 *</p><p>
 * This class is a bridge between arbitrary {@link jtopas.Tokenizer} 
 * implementations using the SPI interface {@link SequenceHandler} and any 
 * {@link jtopas.TokenizerProperties} implementation that does not 
...
public class StandardSequenceHandler implements SequenceHandler {
  ...
  /**
   * The constructor takes the {@link jtopas.TokenizerProperties}
   * that provide the special sequences.
   *
   * @param props   the {@link jtopas.TokenizerProperties} to take the 
   *                sequences from 
   */
