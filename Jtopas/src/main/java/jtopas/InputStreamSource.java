 ...
 *</p><p>
 * The class can be compared with {@link util.InputStreamTokenizer},
 * that has approximately the same (own) method set. While the <code>InputStreamTokenizer</code>
 * is a class directly derived from {@link util.AbstractTokenizer},
...
public class InputStreamSource implements TokenizerSource {
   ...
   * {@link util.Tokenizer} probably read ahead a huge part or 
