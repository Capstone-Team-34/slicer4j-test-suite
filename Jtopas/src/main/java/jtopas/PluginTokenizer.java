...
import util.TokenizerProperty;
import util.TokenizerException;
import util.AbstractTokenizer;
 ...
 * basic interface {@link util.Tokenizer} requires to add 
...
public class PluginTokenizer extends AbstractTokenizer {
   ...
   * base method of {@link util.AbstractTokenizer} in that case.
   *
   ...
   * done by the base method of {@link util.AbstractTokenizer}.
   *
   ...
   * @throws TokenizerException failure while reading data from the input stream
   * @return a {@link util.TokenizerProperty} if a special sequence 
